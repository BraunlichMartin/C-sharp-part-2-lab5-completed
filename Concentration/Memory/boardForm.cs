...
namespace Memory
{
    public partial class boardForm : Form
    {
        ...
        int matches = 0;
        Card[] cards = new Card[21];    //Will use 20 cards referenced as Card[1] to Card[20]
        #endregion
...
*/
        ...
        private void ShuffleCards()
        {
            ...
            {
                int randomIndex = generator.Next(1, 21);
                Card temp1 = cards[randomIndex];
                
                cards[randomIndex] = cards[i];
                cards[i] = temp1;
            
                //PictureBox randomIndex = temp1;
                //SetCardFilename(randomIndex, GetCard(i));
                //SetCardFilename(i, temp);

                //PictureBox card = temp;
